...
public class RoomReservationWebControllerTest {
    ...
    public void getReservations() throws Exception {
        ...
        given(reservationService.getRoomReservations(date)).willReturn(roomReservations);

        this.mockMvc
                .perform(get("/reservations?date=2020-01-01"))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("Jansen, Jan")));
    }
}
